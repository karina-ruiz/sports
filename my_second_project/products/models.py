...
class Product(models.Model):
    name = models.TextField(max_length=10, verbose_name="nombre", null=True)
    photo = models.ImageField(upload_to="logos", null=True, verbose_name="foto")
    brand = models.TextField(max_length=10, verbose_name="marca", null=True, blank=True)
    code = models.TextField(max_length=10, verbose_name="codigo", null=True)
    detail = models.TextField(max_length=100, verbose_name="descripcion", null=True)
    ...
    unit_cost = models.DecimalField(max_digits=9, decimal_places=6, verbose_name="costo_unitario", null=True)
